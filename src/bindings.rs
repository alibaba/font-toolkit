            ...
            pub mod fontkit_interface {
                ...
                impl TextMetrics {
                    ...
                    pub unsafe fn dtor<T: 'static>(handle: *mut u8) {
                        Self::type_guard::<T>();
                        let _ = unsafe {
                            _rt::Box::from_raw(handle as *mut _TextMetricsRep<T>)
                        };
                    }
                ...
                impl GlyphBitmap {
                    ...
                    pub unsafe fn dtor<T: 'static>(handle: *mut u8) {
                        Self::type_guard::<T>();
                        let _ = unsafe {
                            _rt::Box::from_raw(handle as *mut _GlyphBitmapRep<T>)
                        };
                    }
                ...
                impl Font {
                    ...
                    pub unsafe fn dtor<T: 'static>(handle: *mut u8) {
                        Self::type_guard::<T>();
                        let _ = unsafe {
                            _rt::Box::from_raw(handle as *mut _FontRep<T>)
                        };
                    }
                ...
                impl FontKit {
                    ...
                    pub unsafe fn dtor<T: 'static>(handle: *mut u8) {
                        Self::type_guard::<T>();
                        let _ = unsafe {
                            _rt::Box::from_raw(handle as *mut _FontKitRep<T>)
                        };
                    }
                ...
                >(arg0: *mut u8) -> i32 {
                    ...
                    let result0 = T::duplicate(
                        unsafe { TextMetricsBorrow::lift(arg0 as u32 as usize) }.get(),
                    );
                ...
                >(arg0: *mut u8, arg1: i32) {
                    ...
                    T::append(
                        unsafe { TextMetricsBorrow::lift(arg0 as u32 as usize) }.get(),
                        unsafe { TextMetrics::from_handle(arg1 as u32) },
                    );
                }
                #[doc(hidden)]
                #[allow(non_snake_case)]
                ...
                >(arg0: *mut u8) -> i32 {
                    #[cfg(target_arch = "wasm32")] _rt::run_ctors_once();
                    let result0 = T::width(
                        unsafe { GlyphBitmapBorrow::lift(arg0 as u32 as usize) }.get(),
                    );
                    _rt::as_i32(result0)
                }
                #[doc(hidden)]
                ...
                pub unsafe fn _export_method_font_has_glyph_cabi<T: GuestFont>(
                    ...
                    let result0 = T::has_glyph(
                        unsafe { FontBorrow::lift(arg0 as u32 as usize) }.get(),
                ...
                pub unsafe fn _export_method_font_kit_set_config_cabi<T: GuestFontKit>(
                    ...
                    #[cfg(target_arch = "wasm32")] _rt::run_ctors_once();
                    T::set_config(
                        unsafe { FontKitBorrow::lift(arg0 as u32 as usize) }.get(),
                        arg1 as u32,
                        match arg2 {
                            0 => None,
                            1 => {
                                    ...
                                    .add(i * (8 + 12 * ::core::mem::size_of::<*const u8>()));
                                {
                                    ...
                                    for (i, e) in vec11.into_iter().enumerate() {
                                            ...
                                            .add(i * (4 * ::core::mem::size_of::<*const u8>()));
                                        {
                                            ...
                                            *base
                                                .add(3 * ::core::mem::size_of::<*const u8>())
                                                .cast::<u16>() = (_rt::as_i32(language_id9)) as u16;
                                        }
                                    }
                                    *base
                                        .add(::core::mem::size_of::<*const u8>())
                                    ...
                                    *base.add(0).cast::<*mut u8>() = result11;
                                    ...
                                    for (i, e) in vec14.into_iter().enumerate() {
                                            ...
                                            .add(i * (4 * ::core::mem::size_of::<*const u8>()));
                                        {
                                            ...
                                            *base
                                                .add(3 * ::core::mem::size_of::<*const u8>())
                                                .cast::<u16>() = (_rt::as_i32(language_id12)) as u16;
                                        }
                                    }
                                    *base
                                        .add(3 * ::core::mem::size_of::<*const u8>())
                                    ...
                                    *base
                                    ...
                                    match italic16 {
                                        Some(e) => {
                                            *base
                                                ...
                                                .cast::<u8>() = (1i32) as u8;
                                            *base
                                                .add(5 + 7 * ::core::mem::size_of::<*const u8>())
                                                .cast::<u8>() = (match e {
                                                true => 1,
                                                false => 0,
                                            }) as u8;
                                    ...
                                    match stretch16 {
                                        Some(e) => {
                                            *base
                                                .add(6 + 7 * ::core::mem::size_of::<*const u8>())
                                                .cast::<u8>() = (1i32) as u8;
                                            *base
                                    ...
                                    *base
                                    ...
                                    let layout20 = _rt::alloc::Layout::from_size_align_unchecked(
                                        vec20.len() * (3 * ::core::mem::size_of::<*const u8>()),
                                        ::core::mem::size_of::<*const u8>(),
                                    );
                        ...
                        _ => {
                            ...
                            for i in 0..len23 {
                                    ...
                                    .add(i * (8 + 12 * ::core::mem::size_of::<*const u8>()));
                                {
                                    ...
                                    _rt::cabi_dealloc(
                                        base22,
                                        len22 * (3 * ::core::mem::size_of::<*const u8>()),
                                        ::core::mem::size_of::<*const u8>(),
                                    );
                                }
                            }
                            _rt::cabi_dealloc(
                                base23,
                                len23 * (8 + 12 * ::core::mem::size_of::<*const u8>()),
                                ::core::mem::size_of::<*const u8>(),
                            );
                        }
                    }
                ...
                pub unsafe fn _export_method_font_kit_fonts_info_cabi<T: GuestFontKit>(
                    ...
                    let layout15 = _rt::alloc::Layout::from_size_align_unchecked(
                        vec15.len() * (8 + 12 * ::core::mem::size_of::<*const u8>()),
                        ::core::mem::size_of::<*const u8>(),
                    );
                            ...
                            .add(i * (8 + 12 * ::core::mem::size_of::<*const u8>()));
                        {
                            ...
                            for (i, e) in vec5.into_iter().enumerate() {
                                    ...
                                    .add(i * (4 * ::core::mem::size_of::<*const u8>()));
                                {
                                    ...
                                    *base
                                        .add(3 * ::core::mem::size_of::<*const u8>())
                                        .cast::<u16>() = (_rt::as_i32(language_id3)) as u16;
                                }
                            }
                            *base
                                .add(::core::mem::size_of::<*const u8>())
                            ...
                            *base.add(0).cast::<*mut u8>() = result5;
                            ...
                            for (i, e) in vec8.into_iter().enumerate() {
                                    ...
                                    .add(i * (4 * ::core::mem::size_of::<*const u8>()));
                                {
                                    ...
                                    *base
                                        .add(3 * ::core::mem::size_of::<*const u8>())
                                        .cast::<u16>() = (_rt::as_i32(language_id6)) as u16;
                                }
                            }
                            *base
                                .add(3 * ::core::mem::size_of::<*const u8>())
                ...
                pub unsafe fn __post_return_method_font_kit_fonts_info<T: GuestFontKit>(
                    ...
                    _rt::cabi_dealloc(
                        base22,
                        len22 * (8 + 12 * ::core::mem::size_of::<*const u8>()),
                        ::core::mem::size_of::<*const u8>(),
                    );
                }
                #[doc(hidden)]
                ...
                macro_rules! __export_alibaba_fontkit_fontkit_interface_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        ...
                        * mut u8,) -> i32 { unsafe { $($path_to_types)*::
                        ...
                        mut u8, arg1 : f32, arg2 : f32,) -> f32 { unsafe {
                        $($path_to_types)*::
                        ...
                        mut u8, arg1 : f32, arg2 : i32, arg3 : f32,) -> f32 { unsafe {
                        $($path_to_types)*::
                        ...
                        mut u8, arg1 : f32,) -> f32 { unsafe { $($path_to_types)*::
                        ...
                        mut u8,) -> f32 { unsafe { $($path_to_types)*::
                        ...
                        mut u8, arg1 : i32, arg2 : i32,) -> i32 { unsafe {
                        $($path_to_types)*::
                        ...
                        mut u8, arg1 : i32, arg2 : i32,) { unsafe { $($path_to_types)*::
                        ...
                        f32, arg2 : f32, arg3 : f32,) -> i32 { unsafe {
                        $($path_to_types)*::
                        ...
                        * mut u8,) -> f32 { unsafe { $($path_to_types)*::
                        ...
                        u8, arg1 : i32,) -> i32 { unsafe { $($path_to_types)*::
                        ...
                        * mut u8, arg2 : usize,) -> * mut u8 { unsafe {
                        $($path_to_types)*:: _export_method_font_measure_cabi::<<$ty as
                        $($path_to_types)*:: Guest >::Font > (arg0, arg1, arg2) } }
                        #[unsafe (export_name =
                        ...
                        i32, arg2 : f32, arg3 : f32,) -> * mut u8 { unsafe {
                        $($path_to_types)*:: _export_method_font_bitmap_cabi::<<$ty as
                        $($path_to_types)*:: Guest >::Font > (arg0, arg1, arg2, arg3) } }
                        #[unsafe (export_name =
                        ...
                        * mut u8,) -> * mut u8 { unsafe { $($path_to_types)*::
                        ...
                        unsafe { $($path_to_types)*::
                        _export_constructor_font_kit_cabi::<<$ty as $($path_to_types)*::
                        Guest >::FontKit > () } } #[unsafe (export_name =
                        ...
                        u8, arg10 : usize,) -> * mut u8 { unsafe { $($path_to_types)*::
                        ...
                        { unsafe { $($path_to_types)*::
                        _export_method_font_kit_len_cabi::<<$ty as $($path_to_types)*::
                        Guest >::FontKit > (arg0) } } #[unsafe (export_name =
                        ...
                        { unsafe { $($path_to_types)*::
                        _export_number_width_to_str_cabi::<$ty > (arg0) } } #[unsafe
                        (export_name =
...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:alibaba:fontkit:fontkit:encoded world"
)]
#[doc(hidden)]
...
tkit\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\x0dwit-component\x070.227.1\
