        ...
        pub mod fontkit {
            ...
            pub mod fontkit_interface {
                ...
                pub trait GuestFontKit: 'static {
                    ...
                    fn set_config(&self, limit: u32, cache_path: Option<_rt::String>);
...
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.36.0:alibaba:fontkit:fontkit:encoded world"]
#[doc(hidden)]
...
tkit\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\x0dwit-component\x070.220.0\
